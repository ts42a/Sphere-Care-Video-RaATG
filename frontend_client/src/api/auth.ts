...
export async function registerUser(
  ...
  const jsonResult = await request<any>("/auth/register", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
  ...
  const normalized = normalizeLoginResponse(jsonResult, payload.email);
...
export async function requestPasswordReset(
  ...
  return request<ForgotPasswordResponse>("/password/forgot-password", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function verifyResetCode(
  ...
  throw new Error("Verification by code is not enabled. Use the reset link sent to your email.");
}
...
export async function resetPassword(
  ...
  await request<{ message?: string }>("/password/reset-password", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
