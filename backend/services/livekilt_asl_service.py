        ...
        try:
            ...
            async for frame_event in video_stream:
                ...
                await transcript_service.broadcast_caption(
                    ...
                    text=text,
                    language=result.get("language", "asl"),
                    confidence=confidence,
                    is_final=True,
                    # Extra field so the frontend can distinguish ASL vs speech.
                    # transcript_service.broadcast_caption should accept **kwargs
                    # or expose a ``modality`` parameter; if not, add it there.
                    modality="asl",
                )
